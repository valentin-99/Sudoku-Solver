...
def detect_grid_lines(image):
    ...
    lines = cv2.HoughLinesP(thresholdImage, 1, np.pi / 180, threshold=100, minLineLength=100, maxLineGap=7)
    ...
    for line in lines:
        x1, y1, x2, y2 = line[0]
        cv2.line(lines_image, (x1, y1), (x2, y2), 255, 3)
